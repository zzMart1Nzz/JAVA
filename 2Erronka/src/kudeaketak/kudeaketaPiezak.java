...
public class kudeaketaPiezak {
    ...
    public void sortuPieza(Pieza pieza) {
        String sql = "INSERT INTO pieza (idPieza, kategoria, marka, modeloa, ezaugarriak, erosketaPrezioa, Stock) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void ezabatuPieza(int idPieza) {
