...
public class aldaketaEskaerak extends JFrame {
	...
	public aldaketaEskaerak() {
		...
		JLabel lblNewLabel_2 = new JLabel("fraZkia:");
		...
		JLabel lblNewLabel_2_1 = new JLabel("Bezeroa_idBezeroa");
		...
		txt_prezioa.setBounds(608, 237, 106, 20);
