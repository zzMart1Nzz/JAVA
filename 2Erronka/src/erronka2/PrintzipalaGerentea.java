...
public class PrintzipalaGerentea extends JFrame {
	...
	public PrintzipalaGerentea() {
		...
		btnSaioaItxi.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/saioaItxi(1).png")));
		...
		lblBalorazioakIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/balorazioak(1).png")));
		...
		lblEskaeraIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/eskaerak(1).png")));
		...
		lblPiezaEskIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/piezenEskaera(1).png")));
		...
		lblPiezakIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/piezak(1).png")));
		...
		btnAtera.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/itxi(2).png")));
		...
		lblHornitzaileakIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/hornitzaileak(1).png")));
		...
		lblBezeroakIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/bezeroak(1).png")));
		...
		lblProduktuakIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/produktuak(1).png")));
		...
		lblProduktPresIco_G.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/produktuakPrestakuntzan(1).png")));
		...
		lblNewLabel.setIcon(new ImageIcon(PrintzipalaGerentea.class.getResource("/media/UTech java fondoa 1(2).png")));
