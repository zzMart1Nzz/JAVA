...
public class BezeroakPanela extends JFrame {
    ...
    public BezeroakPanela() {
        ...
        btnAtzera.setIcon(new ImageIcon(BezeroakPanela.class.getResource("/media/atzera 2(2).png")));
        ...
        btnAtera.setIcon(new ImageIcon(BezeroakPanela.class.getResource("/media/itxi(2).png")));
        ...
        ezabatuIkonoa.setIcon(new ImageIcon(BezeroakPanela.class.getResource("/media/ezabatu(1).png")));
        ...
        ezabatuIkonoa.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                	// ID-a hartu
	                int idBezeroa = Integer.parseInt(txt_id.getText());

	                // Hornitzailea bilatu ID-a erabiliz
	                Bezeroa bezeroa = lortuBezeroaIdarekin(idBezeroa);

	                if (bezeroa != null) {

	                	ezabatuBezeroa(idBezeroa); // Produktua ezabatu
	                } else {
	                    // Hornitzailea ez bada aurkitu, errore-mezua erakutsi
	                    JOptionPane.showMessageDialog(null, "Bezeroa ez da aurkitu ID honekin: " + idBezeroa, "Errorea", JOptionPane.ERROR_MESSAGE);
	                }
