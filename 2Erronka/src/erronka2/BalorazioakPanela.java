...
public class BalorazioakPanela extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
                try {
                    BalorazioakPanela frame = new BalorazioakPanela();
    ...
    public BalorazioakPanela() {
        ...
        btnAtzera.setIcon(new ImageIcon(BalorazioakPanela.class.getResource("/media/atzera 2(2).png")));
        ...
        btnAtera.setIcon(new ImageIcon(BalorazioakPanela.class.getResource("/media/itxi(2).png")));
        ...
        contentPane.add(lblNewLabel_1);
         ...
         birkargatuIko.setIcon(new ImageIcon(BalorazioakPanela.class.getResource("/media/birkargatu(1).png")));
        ...
        ezabatuIkonoa.setIcon(new ImageIcon(BalorazioakPanela.class.getResource("/media/ezabatu(1).png")));
        ...
        ezabatuIkonoa.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                lblNewLabel.setIcon(new ImageIcon(BalorazioakPanela.class.getResource("/media/UTech java fondoa 1(2).png")));
