...
public class LProdPrestPanela extends JFrame {
    ...
    public LProdPrestPanela() {
        ...
        btnAtzera.setIcon(new ImageIcon(LProdPrestPanela.class.getResource("/media/atzera 2(2).png")));
        ...
        btnAtera.setIcon(new ImageIcon(LProdPrestPanela.class.getResource("/media/itxi(2).png")));
        ...
        contentPane.add(btnAtera);
         ...
         birkargatuIko.setIcon(new ImageIcon(LProdPrestPanela.class.getResource("/media/birkargatu(1).png")));
         ...
         birkargatuIko.addMouseListener(new MouseAdapter() {
                ...
                lblNewLabel.setIcon(new ImageIcon(LProdPrestPanela.class.getResource("/media/UTech java fondoa 1(2).png")));
