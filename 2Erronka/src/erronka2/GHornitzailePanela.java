...
public class GHornitzailePanela extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
                try {
                    GHornitzailePanela frame = new GHornitzailePanela();
    ...
    public GHornitzailePanela() {
        ...
        aldatuIkonoa.setIcon(new ImageIcon(GHornitzailePanela.class.getResource("/media/editatu(1).png")));
        ...
        btnAtera.setIcon(new ImageIcon(GHornitzailePanela.class.getResource("/media/itxi(2).png")));
        ...
        birkargatuIko.setIcon(new ImageIcon(GHornitzailePanela.class.getResource("/media/birkargatu(1).png")));
        ...
        ezabatuIkonoa.setIcon(new ImageIcon(GHornitzailePanela.class.getResource("/media/ezabatu(1).png")));
        ...
        ezabatuIkonoa.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                label.setIcon(new ImageIcon(GHornitzailePanela.class.getResource("/media/UTech java fondoa 1(2).png")));
