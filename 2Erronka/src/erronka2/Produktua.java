...
public class Produktua {
	...
	public int getProduktuMotaId() {
		return produktuMotaId;
	}

	public void setProduktuMotaId(int produktuMotaId) {
		this.produktuMotaId = produktuMotaId;
	}
	...
	public String getErresoluzioa() {
		return erresoluzioa;
	}

	public void setErresoluzioa(String erresoluzioa) {
		this.erresoluzioa = erresoluzioa;
	}
