...
public class EskHistorikoPanela extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EskHistorikoPanela frame = new EskHistorikoPanela();
	...
	public EskHistorikoPanela() {
		...
		lblNewLabel_1.setBounds(741, 419, 247, 32);
		...
		btnAtzera.setIcon(new ImageIcon(EskHistorikoPanela.class.getResource("/media/atzera 2(2).png")));
		...
		btnAtera.setIcon(new ImageIcon(EskHistorikoPanela.class.getResource("/media/itxi(2).png")));
		...
		lblNewLabel.setIcon(new ImageIcon(EskHistorikoPanela.class.getResource("/media/UTech java fondoa 1(2).png")));
