...
public class EskaeraPanela extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
                try {
                    EskaeraPanela frame = new EskaeraPanela();
    ...
    public EskaeraPanela() {
        ...
        btnAtzera.setIcon(new ImageIcon(EskaeraPanela.class.getResource("/media/atzera 2(2).png")));
        ...
        btnAtera.setIcon(new ImageIcon(EskaeraPanela.class.getResource("/media/itxi(2).png")));
        ...
        okIkonoa.setIcon(new ImageIcon(EskaeraPanela.class.getResource("/media/ok(1).png")));
        ...
        lblNewLabel.setIcon(new ImageIcon(EskaeraPanela.class.getResource("/media/UTech java fondoa 1(2).png")));
